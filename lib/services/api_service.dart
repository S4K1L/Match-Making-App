...
class ApiService {
  final String devUrl = ApiConstant.BASE_URL;
  final String imageUrl = ApiConstant.BASE_URL_IMAGE;
  final String webSocket = ApiConstant.BASE_URL_IMAGE;
  final String prodUrl = "";
  static final String imgUrl = ApiConstant.BASE_URL_IMAGE;
  ...
  Future<http.Response> patchMultipartData(
    ...
    try {
      ...
      for (MultipartBody element in multipartBody) {
        ...
        debugPrint(
          "📤 Uploading file: ${element.file.path} [${mediaType.mimeType}]",
        );
