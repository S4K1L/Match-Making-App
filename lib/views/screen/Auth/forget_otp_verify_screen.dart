...
class ForgetOtpVerifyScreen extends StatefulWidget {
  final String email;
  const ForgetOtpVerifyScreen({super.key, required this.email});

  @override
  State<ForgetOtpVerifyScreen> createState() => _ForgetOtpVerifyScreenState();
}

class _ForgetOtpVerifyScreenState extends State<ForgetOtpVerifyScreen> {
