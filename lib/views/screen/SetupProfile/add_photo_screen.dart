                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Obx(
                          () => CustomButton(
                            onTap: () async {
                              if (_setupProfileController
                                  .photosUploading
                                  .value) {
                                return;
                              }
                              final ok = await _setupProfileController
                                  .uploadPopImages();
                              if (ok && mounted) {
                                Get.to(() => const FaceScanningScreen());
                              }
                            },
                            text: _setupProfileController.photosUploading.value
                                ? "Uploading..."
                                : "Next",
                            loading:
                                _setupProfileController.photosUploading.value,
                          ),
                        ),
                      ],
                    ),
